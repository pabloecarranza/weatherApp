        ...
        <div className={Styles.textArea}>
          <div className={Styles.text}>
            ...
            <span>
             ...
             <br /> 🐱<a href="https://github.com/pabloecarranza" target="_blank">  https://github.com/pabloecarranza</a>
              
              <br /><br />
              Ademas te dejo mi correo para que estemos en contacto: <br />
              📬<a href="mailto:pabloecarranza@gmail.com">pabloecarranza@gmail.com</a>
